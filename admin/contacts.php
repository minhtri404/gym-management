...
<head>
  ...
  <title>Liên h? khách hàng - Gym Management</title>
    ...
    <main class="main-content flex-grow-1">
      ...
      <div class="container-fluid p-4">
        <?php if (isset($_GET['update']) && $_GET['update'] === 'success'): ?>
          <div class="alert alert-success">C?p nh?t liên h? thành công.</div>
        <?php endif; ?>

        <?php if (isset($_GET['delete']) && $_GET['delete'] === 'success'): ?>
          <div class="alert alert-success">Xóa liên h? thành công.</div>
        <?php endif; ?>

        <div class="d-flex justify-content-between align-items-center mb-4">
          <div>
            <h4 class="mb-1">Qu?n lý liên h? khách hàng</h4>
            <p class="text-muted mb-0">Theo dõi yêu c?u liên h?, tình tr?ng x? lý và ghi chú cham sóc khách hàng.</p>
          </div>
          <div>
            <a href="contact-form.php" target="_blank" class="btn btn-outline-primary">
              Xem form liên h? public
            </a>
          </div>
        </div>
        ...
        <div class="row g-4 mb-4">
          <div class="col-md-6 col-xl-3">
            <div class="card border-0 shadow-sm h-100">
              <div class="card-body">
                <div class="text-muted mb-2">T?ng yêu c?u</div>
        ...
        <form method="GET" class="row g-3 align-items-end">
          <div class="col-md-4">
            ...
            <input
              ...
              name="keyword"
              class="form-control"
              placeholder="Tên / SÐT / Email / Ch? d?"
        ...
        <div class="card border-0 shadow-sm">
          <div class="card-header bg-white border-0 pt-4 px-4">
            <h5 class="mb-0">Danh sách yêu c?u liên h?</h5>
          </div>
            ...
            <div class="table-responsive">
              <table class="table align-middle">
                ...
                <tbody>
                    ...
                    <?php while ($row = $result->fetch_assoc()): ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <div class="small text-muted">Uu tiên: <?php echo htmlspecialchars($row['preferred_contact_method']); ?></div>
                        </td>
                        ...
                        <td class="text-end" style="min-width: 320px;">
                          ...
                          <form method="POST" class="mt-2" onsubmit="return confirm('Xóa liên h? này?');">
                            <input type="hidden" name="id" value="<?php echo (int) $row['id']; ?>">
                            <input type="hidden" name="csrf_token" value="<?php echo $_SESSION['csrf_token']; ?>">
                  ...
                  <?php else: ?>
                    <tr>
                      <td colspan="7" class="text-center text-muted">Chua có yêu c?u liên h? nào.</td>
                    </tr>
                  <?php endif; ?>
                </tbody>
              </table>
