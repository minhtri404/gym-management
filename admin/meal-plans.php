                    ...
                    <div class="col-lg-5">
                        <div class="card border-0 shadow-sm">
                            ...
                            <div class="card-body px-4 pb-4">
                                <form method="POST" action="<?php echo $root_base_path; ?>php/ai/meal-plans.php">
                                        ...
                                        <?php foreach ($plans as $plan): ?>
                                            <div class="plan-box">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center mt-2">
                                                    <div class="small text-muted">Tạo lúc: <?php echo h($plan['created_at']); ?></div>
                                                    <a href="<?php echo $root_base_path; ?>php/ai/edit-meal-plan.php?id=<?php echo (int) $plan['id']; ?>" class="btn btn-sm btn-outline-warning">
