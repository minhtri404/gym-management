...
$base_path = '';
$public_base_url = 'http://192.168.1.145:8086/';
                    ...
                    <div class="col-lg-4">
                        <div class="card border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <?php endif; ?>
                                <?php if (isset($_GET['not_premium'])): ?>
                                    <div class="alert alert-danger">Chỉ hội viên đang dùng gói giá cao mới được phép check-in theo hệ thống này.</div>
                                <?php endif; ?>

                                <?php if (isset($_GET['expired'])): ?>
                                    <div class="alert alert-danger">Hội viên này có gói tập đã hết hạn, không thể check-in.</div>
                                <?php endif; ?>

                                <?php if (isset($_GET['inactive'])): ?>
                                    <div class="alert alert-danger">Hội viên này đang không hoạt động.</div>
                                <?php endif; ?>
