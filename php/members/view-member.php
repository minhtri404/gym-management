                            ...
                            <div class="card-body px-4 pb-4">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div><?php echo isset($member['package_price']) ? number_format((float) $member['package_price'], 0, ',', '.') . ' VNĐ' : 'Chưa có'; ?></div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div><?php echo isset($member['duration_months']) ? (int) $member['duration_months'] . ' tháng' : 'Chưa có'; ?></div>
                                    </div>
