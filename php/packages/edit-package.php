...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($package_name === '' || $duration_months <= 0 || $price < 0) {
        $error = "Vui lòng nh?p d?y d? và dúng d?nh d?ng các tru?ng b?t bu?c.";
    } else {
        ...
        $error = "C?p nh?t gói t?p th?t b?i: " . $stmt->error;
        $stmt->close();
    }
}
    ...
    <div class="main-content flex-grow-1">
      ...
      <div class="container-fluid p-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
          <h2 class="fw-bold">S?a gói t?p</h2>
              ...
              <div class="row g-3">
                ...
                <div class="col-md-4">
                  ...
                  <select name="status" class="form-select">
                    <option value="active" <?php echo (($package['status'] ?? '') === 'active') ? 'selected' : ''; ?>>Ðang ho?t d?ng</option>
                ...
                <div class="col-12 mt-4">
                  <button type="submit" class="btn btn-primary">
                    <i class="bi bi-save me-1"></i> C?p nh?t gói t?p
                  </button>
