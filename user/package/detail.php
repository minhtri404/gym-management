...
<head>
    ...
    <title>Chi tiết gói tập - <?php echo htmlspecialchars($package['package_name']); ?></title>
    ...
    <div class="container" style="margin-top: 80px;">
        <div class="row g-4 align-items-center">
            <div class="col-lg-8">
                ...
                <h1 class="fw-bold mb-3 package-detail-title"><?php echo htmlspecialchars($package['package_name']); ?></h1>
                <p class="mb-0 package-detail-subtitle"><?php echo htmlspecialchars($package['short_description'] ?: ($package['description'] ?: 'Gói tập phù hợp cho nhiều mục tiêu luyện tập khác nhau.')); ?></p>
            </div>
            <div class="col-lg-4">
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm rounded-4 mb-4">
                    <div class="card-body p-4">
                        ...
                        <div class="text-muted"><?php echo nl2br(htmlspecialchars($package['detail_content'] ?: ($package['description'] ?: 'Hiện chưa có mô tả chi tiết cho gói tập này.'))); ?></div>
                    </div>
                </div>
                        ...
                        <?php if (!empty($benefits_lines)): ?>
                            <ul class="mb-0 text-muted">
                                <?php foreach ($benefits_lines as $item): ?>
                                    <?php if (trim($item) !== ''): ?>
                                        <li class="mb-2"><?php echo htmlspecialchars(trim(ltrim($item, "- \t"))); ?></li>
                                    <?php endif; ?>
                                <?php endforeach; ?>
                            </ul>
                        <?php else: ?>
            ...
            <div class="col-lg-4">
                ...
                <div class="card border-0 shadow-sm rounded-4">
                    <div class="card-body p-4">
                        ...
                        <p class="text-muted mb-0"><?php echo htmlspecialchars($package['suitable_for'] ?: 'Người muốn cải thiện sức khỏe, vóc dáng và duy trì thói quen luyện tập.'); ?></p>
                    </div>
                </div>
            </div>
        </div>
