...
<nav class="navbar navbar-expand-lg navbar-dark user-navbar fixed-top">
    <div class="container">
        <a class="navbar-brand fw-bold d-flex align-items-center" href="<?php echo $base_path; ?>user/home">
        ...
        <div class="collapse navbar-collapse" id="userNavbar">
            <ul class="navbar-nav ms-auto align-items-lg-center">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $base_path; ?>user/trainers/index">HLV</a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $base_path; ?>user/dashboard/index">Khu v&#7921;c h&#7897;i vi&ecirc;n</a>
                </li>
                ...
                <?php if (!empty($_SESSION['user_id'])): ?>
                    ...
                    <li class="nav-item dropdown ms-lg-3">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end user-dropdown-menu">
                            <li>
                                <a class="dropdown-item" href="<?php echo $base_path; ?>user/profile">
                                    <i class="bi bi-person-circle me-2"></i>H&#7891; s&#417; c&aacute; nh&acirc;n
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="<?php echo $base_path; ?>user/my-package/index">
                                    <i class="bi bi-box-seam me-2"></i>G&oacute;i c&#7911;a b&#7841;n
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="<?php echo $base_path; ?>user/registrations/index">
                                    <i class="bi bi-card-checklist me-2"></i>L&#7883;ch s&#7917; &#273;&#259;ng k&yacute;
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="<?php echo $base_path; ?>user/checkins/index">
                                    <i class="bi bi-calendar-check me-2"></i>L&#7883;ch s&#7917; check-in
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="<?php echo $base_path; ?>user/trainers/my-bookings">
                                    <i class="bi bi-person-badge me-2"></i>L&#7883;ch s&#7917; HLV
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="<?php echo $base_path; ?>user/contacts/index">
                ...
                <?php else: ?>
                    <li class="nav-item ms-lg-3">
                        <a class="btn btn-hero-primary btn-sm" href="<?php echo $base_path; ?>login">&#272;&#259;ng nh&#7853;p</a>
                    </li>
                <?php endif; ?>
            </ul>
        </div>
