                            ...
                            <div class="col-md-6 col-lg-4 d-flex">
                                <div class="package-card package-card-modern reveal-up w-100">
                                    ...
                                    <div class="package-actions mt-auto">
                                        <a href="<?php echo $base_path; ?>contact-form.php" class="btn btn-hero-primary w-100 mb-2">
                                            Đăng ký tư vấn
                                        </a>

                                        <a href="<?php echo $base_path; ?>user/package-register.php?package_id=<?php echo (int)$pkg['id']; ?>" class="btn btn-hero-primary w-100 mb-2">
    Đăng ký gói này
</a>
                                        <a href="<?php echo $base_path; ?>user/contact.php" class="btn btn-user-outline w-100">
                                            Liên hệ ngay
                                        </a>
                                    </div>
                                </div>
